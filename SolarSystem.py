...
if __name__ == "__main__":
    ...
    ss.add_body(Body(1988500e24, 695700e3, (6.581238156405360E+08, -4.158903482447704E+07),
                     (2.495612123392373, 9.727975051467044), (0.0, 0.0, 2.865329607243705e-06)))  # The Sun
    ss.add_body(Body(5.97e24, 12756e3 / 2, (1.601622423200423E+09, 1.471196461264217E+11),
                     (-3.028433032337041E+04, 8.741108700584631E+01), (0.0, 0.0, 7.292115053925690e-05)))  # The Earth
    ss.add_body(Body(0.073e24, 3475e3 / 2, (1.707846768008920E+09, 1.467782024215504E+11),
                     (-2.922740436493338E+04, 3.794473047545215E+02), (0.0, 0.0, 2.661699538941653e-06)))  # The Moon
    ...
    axes = fig.add_subplot(111, aspect='equal', autoscale_on=False,
                           xlim=(-1.6e11, 1.6e11), ylim=(-1.6e11, 1.6e11))
